<template>
    <div class="bg-white">
        ...
        <div class="fixed top-0 right-0 hidden h-full w-1/2 bg-blue-900 lg:block" aria-hidden="true" />

        <header
            class="relative mx-auto max-w-7xl bg-blue-900 py-6 lg:grid lg:grid-cols-2 lg:gap-x-16 lg:bg-transparent lg:px-8 lg:pt-16 lg:pb-10">
        ...
        <main class="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8">
            ...
            <section aria-labelledby="summary-heading"
                class="bg-blue-900 pt-6 pb-12 text-blue-300 md:px-10 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:w-full lg:max-w-lg lg:bg-transparent lg:px-0 lg:pt-0 lg:pb-24">
                ...
                <form>
                    <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                        ...
                        <div class="mt-10 flex justify-end border-t border-gray-200 pt-6">
                            <button type="submit"
                                class="rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-50">Pay
                                now</button>
                        </div>
                    </div>
                </form>
