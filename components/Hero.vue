<template>
  <div class="relative overflow-hidden bg-white">
    ...
    <div class="relative pt-6 pb-16 sm:pb-24">
      <div
        class="mx-auto mt-16 max-w-7xl px-4 sm:mt-24 flex flex-col-reverse md:flex-row"
      >
        <div class="lg:max-w-2/3 flex-shrink">
          ...
          <h1 class="text-6xl font-bold text-black" data-aos="fade-up">
            Join Crypto Goats Today!
          </h1>
          <p class="py-6 text-3xl" data-aos="fade-up" data-aos-delay="100">
            Crypto Goats is the home of the best Crypto Traders, with numerous
            years of experience! We provide Trading Signals, Low-Cap Crypto's,
          ...
          <div class="flex">
            <a v-for="(partner, index) in partners" :href="partner.link"
              ><img
                :src="partner.image"
                class="max-w-32 max-h-32 pr-4"
                data-aos="fade-up"
...
const partners: Partner[] = [
  {
    link: "https://promote.mexc.com/a/cryptogoats",
    image: "/img/mexc_saturation.png",
  },
  {
    link: "https://www.kucoin.com/r/af/QBSSSCCK",
    image: "/img/kucoin_saturation.png",
  },
  {
    link: "https://partner.bybit.com/b/cryptogoats",
    image: "/img/bybit_saturation.png",
  },
];
</script>
